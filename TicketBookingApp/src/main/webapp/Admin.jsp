...
<%
    ...
    try {
        ...
        if ("add".equals(action) && "movie".equals(type)) {
            ...
            ps = conn.prepareStatement("INSERT INTO movies (name, img, duration) VALUES (?, ?, ?)");
            ps.setString(1, name);
            ps.setString(2, url);
            ...
            if ("movie".equals(type)) {
                ...
                ps = conn.prepareStatement("DELETE FROM register WHERE id=?");
            ...
            if ("movie".equals(type)) {
                ...
                String duration = request.getParameter("duration");
                ps = conn.prepareStatement("UPDATE movies SET name=?, img=?, duration=? WHERE id=?");
                ps.setString(1, name);
        ...
        <table>
            ...
            <tr>
                <form method="post" action="Admin.jsp">
                    ...
                    <td><input type="text" name="image_url" value="<%= rs.getString("img") %>"></td>
